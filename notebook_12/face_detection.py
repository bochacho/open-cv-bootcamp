...
asset_zip_path = os.path.join(os.getcwd(), f"notebook_12/opencv_bootcamp_assets_12.zip")
...
net = cv2.dnn.readNetFromCaffe("notebook_12/deploy.prototxt", "notebook_12/res10_300x300_ssd_iter_140000_fp16.caffemodel")
# Model parameters
in_width = 300
in_height = 300
mean = [104, 117, 123]
